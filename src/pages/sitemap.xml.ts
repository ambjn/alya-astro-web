...
export const GET: APIRoute = () => {
  ...
  const staticRoutes: SitemapEntry[] = [
    ...
    { url: '/vs/italki', lastmod: now, changefreq: 'monthly', priority: 0.7 },
    { url: '/vs/pimsleur', lastmod: now, changefreq: 'monthly', priority: 0.7 },
